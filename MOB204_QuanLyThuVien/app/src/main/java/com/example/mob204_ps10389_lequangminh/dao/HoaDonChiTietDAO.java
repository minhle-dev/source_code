package com.example.mob204_ps10389_lequangminh.dao;
...
import com.example.mob204_ps10389_lequangminh.database.DatabaseHelper;
import com.example.mob204_ps10389_lequangminh.model.HoaDon;
import com.example.mob204_ps10389_lequangminh.model.HoaDonChiTiet;
import com.example.mob204_ps10389_lequangminh.model.Sach;
...
public class HoaDonChiTietDAO {
    ...
    public List<HoaDonChiTiet> getAllHoaDonChiTiet() {
        ...
        try {
            while (c.isAfterLast() == false) {
                ...
                ee.setSach(new Sach(c.getString(3), c.getString(4), c.getString(5), c.getString(6), c.getString(7), c.getDouble(8), c.getString(9)));
    ...
    public List<HoaDonChiTiet> getAllHoaDonChiTietByID(String maHoaDon) {
        ...
        String sSQL = "SELECT maHDCT, HoaDon.maHoaDon,HoaDon.ngayMua, " +
                "Sach.maSach, Sach.maTheLoai, Sach.tenSach, Sach.tacGia, Sach.NXB, Sach.giaBia, " +
                "Sach.soLuong,HoaDonChiTiet.soLuong FROM HoaDonChiTiet INNER JOIN HoaDon " + "on HoaDonChiTiet.maHoaDon = HoaDon.maHoaDon INNER JOIN Sach on Sach.maSach = HoaDonChiTiet.maSach where HoaDonChiTiet.maHoaDon = '" + maHoaDon + "' ";
        Cursor c = db.rawQuery(sSQL, null);
        c.moveToFirst();
        try {
            while (c.isAfterLast() == false) {
                ...
                ee.setHoaDon(new HoaDon(c.getString(1), sdf.parse(c.getString(2))));
                ee.setSach(new
                        Sach(c.getString(3), c.getString(4), c.getString(5), c.getString(6), c.getString(7), c.getDouble(8), c.getString(9)));
                ee.setSoLuongMua(c.getInt(10));
                dsHoaDonChiTiet.add(ee);
                Log.d("//=====", ee.toString());
                c.moveToNext();
